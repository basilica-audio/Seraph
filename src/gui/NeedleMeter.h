...
// Seraph has no photoreal assets at all, so both the face and the needle
// are drawn here.
//
...
// SeraphAudioProcessor::get{DeEss,Comp}GainReductionMeterDb(). The
...
namespace basilica::gui
{
    ...
    {
    public:
        // accessibleTitle: e.g. "Compressor gain reduction meter".
        // faceLegend: the short engraved legend on the face, e.g. "COMP".

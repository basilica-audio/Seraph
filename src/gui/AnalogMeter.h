...
// glow and the rotating needle, composited live on top of the dial face
// already drawn beneath this component (baked into the faceplate on
// silentium; composited as a static dial sprite by the wave-3
// compositional editors - see PluginEditor.cpp). Also OWNS the peak-hold/fade state machine for the
...
namespace basilica::gui
{
    ...
    private:
        ...
        // SERAPH ADAPTATION of the silentium constant: this editor sizes
        // each AnalogMeter to EXACTLY its dial sprite's footprint
        // (sprite_vu_dial.png, a 364 px master-canvas crop of the same
        // master-05 dial the needle sprite was extracted from), so master
        // parity is simply needle canvas / dial sprite canvas:
        // 288 / 364 = 0.791209 (this constant deliberately does NOT
        // depend on PluginEditorLayout.h, to keep this component
        // suite-reusable - see this file's top-of-file docs).
        static constexpr float needleSizeFraction = 0.791209f;

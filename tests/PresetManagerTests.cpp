...
TEST_CASE ("PresetManager: current and legacy preset folders follow the platform convention", "[presets][branding]")
{
    ...
    REQUIRE (current == presetsRoot.getChildFile ("Basilica Audio").getChildFile ("Seraph"));
    REQUIRE (legacy == presetsRoot.getChildFile ("Yves Vogl").getChildFile ("Seraph"));
   #else
    ...
    REQUIRE (current == applicationData.getChildFile ("Basilica Audio")
                            .getChildFile ("Seraph").getChildFile ("Presets"));

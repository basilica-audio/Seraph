...
//
// See basilica-audio/Seraph issue #14: no existing test/CI gate caught
// process()-time heap allocation before this - pluginval/auval don't do
// allocation-instrumented profiling, and none of the 28 pre-existing
// Catch2 tests had an allocation-counting mechanism.
namespace TestAlloc
{
